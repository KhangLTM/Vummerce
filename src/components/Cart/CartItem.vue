              ...
              <div >
                  <div class="flex items-center w-full h-13 pl-3 bg-white bg-gray-100 border rounded-full">
                    <input type="text" name="code"  placeholder="Apply coupon" 
                      ...
                      <button  class="text-sm flex items-center px-3 py-1 text-white bg-gray-700 rounded-full outline-none md:px-4 hover:bg-gray-700 focus:outline-none active:outline-none">
        ...
        <div class="lg:px-2 lg:w-1/2">
          ...
          <div class="p-4">
            <p class="mb-6 italic">Shipping and additionnal costs are calculated based on values you have entered</p>
              ...
              <a>
                <button @click="checkLoggedIn()" type="button" class="flex justify-center w-full px-10 py-3 mt-6 bg-gray-100  hover:bg-gray-800 hover:text-white focus:ring-gray-500 focus:ring-offset-green-200  w-full transition ease-in duration-200 text-gray-900 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
