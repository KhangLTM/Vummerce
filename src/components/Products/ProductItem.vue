<template>
    <div id="prod" class=" lg:flex lg:flex-col justify-between  max-w-xs bg-white shadow-lg rounded-lg overflow-hidden my-5 height">
  <div class="  px-4 py-5  ">
    <h1 @click="clickDetail(items.id)" class="cursor-pointer text-gray-900 font-bold text-3xl uppercase hover:text-blue-600">{{items.title}}</h1>
    <div>
        <Start />
    </div>
